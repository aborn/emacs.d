...
* 2014-02-20 v1.3.6 (add switch-swift in iemacsfun sql mode)
* 2014-03-02 v1.4   (add ace-jump-mode and quick-jump mode)
* 2014-03-02 v1.4.2 (add highlight-tail-mode evil-mode)
...
* 2014-04-25 v1.5.4 (add buffer-dealing.el buffer-move.el)
